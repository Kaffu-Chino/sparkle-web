export default {
  'userCenterView.userInfo.descriptionsItem.uid': 'UID',
  'userCenterView.userInfo.descriptionsItem.registerAt': '注册于',

  'userCenterView.userAppsTable.title': '用户应用程序',
  'userCenterView.userAppsTable.createUserApplication': '创建用户应用程序',
  'userCenterView.userAppsTable.recordId': '记录 ID',
  'userCenterView.userAppsTable.appId': 'App ID',
  'userCenterView.userAppsTable.appSecret': 'AppSecret',
  'userCenterView.userAppsTable.comment': '备注',
  'userCenterView.userAppsTable.createdAt': '创建时间',
  ...
  'userCenterView.userAppInfoDrawer.title.resetAppSecret': '已重置“{comment}”的 AppSecret',
  'userCenterView.userAppInfoDrawer.title.createUserApp': '已创建您的应用程序：{comment} ',
